...
- The [LimitOrderManager](./src/LimitOrderManager.sol) is the contract that contains all the logic to allow users to place limit orders using the Liquidity Book V2.1 Pairs. This contract is self-sufficient and doesn't need any Factory and Router.
